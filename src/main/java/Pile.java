...
public class Pile {
	 ...
	 * Construit une Pile de taille maxi. 100 
	 */
	public Pile() {
	 ...
	 * Constructeur par d�faut.
	 * Construit une Pile 
	 * @param pfTaille : int taille maximum du tableau; doit �tre positif
	 * precondition : pfTaille doit �tre positif 
	 */
	 ...
	 * @param pfElement
	 * pr�condition : la pile ne doit pas �tre pleine
	 */
	 ...
	 * @see 	Pile#estVide()
	 * precondition : la pile ne doit pas �tre vide
	 */
	public void depiler()  {
		this.indiceSommet = this.indiceSommet - 1;
	}
